...
class CRMSetupElement extends HTMLElement {
    ...
    plotRates() {
        ...
        let layout_top = makeLayout('Extra plot');
        ...
        async function plotAllAndSync(element_this) {
            ...
            // Sync visibility for producer charts only (div2, div21, div22)
            let producerDivs = [div2, div21, div22];
            let isSyncingVisibility = false;
            ...
            function updateInjectorVisibility() {
                ...
                // Update injector chart visibility
                div1.data.forEach((trace, i) => {
                    let shouldBeVisible = connectedInjectors.has(trace.name);
                    Plotly.restyle(div1, {'visible': shouldBeVisible}, [i]);
                });
            }

            producerDivs.forEach((sourceDiv) => {
                sourceDiv.on('plotly_restyle', (data) => {
                    if (isSyncingVisibility) return;
                    ...
                    if (data[0] && 'visible' in data[0]) {
                        ...
                        // Apply same visibility changes to other producer charts
                        const otherProducerDivs = producerDivs.filter(div => div !== sourceDiv);
                        otherProducerDivs.forEach(targetDiv => {
                            Plotly.restyle(targetDiv, {'visible': visibilityChanges}, traceIndices);
                        });
        ...
        return `
            <div id='modelling-page' class='page'>
                ...
                <div class="chart-container0" style="width:100%; margin-bottom:15px;">
                    <div id="dd0" style="width:100%; height:250px; background-color:red;"></div>
                </div>
            ...
            <div class='card' id='liquid-history-match-card'>    
                ...
                <div class='row'>
                    ...
                    <div class='col-3'><input class='form-control form-control-sm qo_lambda-initial' id='qo_lambda-initial' type="number" min="0.1" max="1" value="1.0"
                            decimals="1" step="0.1"></div>
                    <div class='col-3'><input class='form-control form-control-sm qo_lambda-min' id='qo_lambda-min' type="number" min="0.0" max="2" value="0"
                            decimals="1" step="0.1"></div>
                    <div class='col-3'><input class='form-control form-control-sm qo_lambda-max'  id='qo_lambda-max' type="number" min="0.0" max="2.0" value="2.0"
                            decimals="1" step="0.1"></div>
                </div>

                <div class='row'>
                    <div class='col-3 text-end'><b>Productivity index</b></div>
                    <div class='col-3'><input class='form-control form-control-sm productivity-initial' id='productivity_index-initial' type="number" min="0.1" max="1" value="0.0"
                            decimals="1" step="0.1"></div>
                    <div class='col-3'><input class='form-control form-control-sm productivity-min' id='productivity_index-min' type="number" min="0.0" max="2" value="0"
                            decimals="1" step="0.1"></div>
        ...
        return `
            <div id='modelling-page' class='page'>
                ...
                <div class="chart-container2" style='display:flex; justify-content: space-evenly;'>
                        ...
                        <div id= 'dd21' style="width:49%" class='sscol-6'></div>
                        <div id= 'dd22' style="width:50%"  class='sscol-6'></div>
                </div>
